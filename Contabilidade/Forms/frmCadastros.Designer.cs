namespace Contabilidade.Forms
{
    partial class frmCadastros
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(344, 159);
            label1.Name = "label1";
            ...
            label3.Location = new Point(344, 243);
            label3.Name = "label3";
            label3.Size = new Size(113, 24);
            label3.TabIndex = 1;
            label3.Text = "Históricos";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Lucida Sans", 15.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            label4.Location = new Point(216, 267);
            label4.Name = "label4";
            label4.Size = new Size(368, 24);
            label4.TabIndex = 1;
            label4.Text = "Usuários (talvez seja inserido aqui)";
            // 
            // frmCadastros
            // 
